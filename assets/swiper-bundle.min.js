...
const buildSwipers = () => {
  const sliders = document.querySelectorAll('.swiper[data-swiper]');
  sliders.forEach((slider) => {
    let data = JSON.parse(slider.getAttribute('data-swiper'));
    console.log(data,slider);
    if(slider.hasAttribute('data-auto-slides')) {
      data.slidesPerView = 'auto';
    }
    var swiper = new Swiper(slider, data);
  });
};
